...
import org.firstinspires.ftc.teamcode.SwyftMecanum;

public class TestPedroPathHardware {
    //private final OpMode myOpMode;

    private Follower follower;

    public TestPedroPathHardware(/*LinearOpMode opMode*/) {
    ...
    private void init() {
        ...
        this.follower = new FollowerBuilder(buildFollowerConstants(), /*myOpMode.hardwareMap*/null)
